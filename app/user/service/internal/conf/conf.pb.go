...
var file_user_service_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x7d, 0x0a, 0x09, 0x42, 0x6f, 0x6f, 0x74, 0x73, 0x74, 0x72, 0x61, 0x70,
	0x12, 0x3a, 0x0a, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x22, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e,
	0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x52, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x34, 0x0a, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x75, 0x73, 0x65,
	...
	0x74, 0x61, 0x22, 0xd8, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x3b, 0x0a,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xfd, 0x02,
	0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x45, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61,
	0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	...
	0x05, 0x72, 0x65, 0x64, 0x69, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x75,
	...
	0x43, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x6f, 0x6f, 0x6d,
...
var file_user_service_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_HTTP)(nil),         // 3: user.service.internal.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 4: user.service.internal.conf.Server.GRPC
	(*Data_Database)(nil),       // 5: user.service.internal.conf.Data.Database
	(*Data_Redis)(nil),          // 6: user.service.internal.conf.Data.Redis
...
var file_user_service_internal_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: user.service.internal.conf.Server.http:type_name -> user.service.internal.conf.Server.HTTP
	4,  // 3: user.service.internal.conf.Server.grpc:type_name -> user.service.internal.conf.Server.GRPC
	5,  // 4: user.service.internal.conf.Data.database:type_name -> user.service.internal.conf.Data.Database
	6,  // 5: user.service.internal.conf.Data.redis:type_name -> user.service.internal.conf.Data.Redis
	7,  // 6: user.service.internal.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	7,  // 7: user.service.internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	7,  // 8: user.service.internal.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	7,  // 9: user.service.internal.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
